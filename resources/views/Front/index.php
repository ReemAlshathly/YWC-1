    ...
    <body>
        <section class="intro-section overflow-hidden" id="intro-section">
            <div class="position-relative" style="min-height: 80vh;">
                    ...
                    <div class="container d-flex align-items-center">
                        ...
                        <nav id="navbar" class="navbar order-last order-lg-0 me-auto">
                            <ul class="d-flex align-items-center">
                                ...
                                <li>
                                    <a class="nav-link" href="#services">المشاريع</a>
                                </li>
                                <li>
                                    <a class="nav-link" href="#services">التقارير</a>
                                </li>
                                <li>
                                    <a class="nav-link" href="#services">الفعاليات</a>
                                </li>
                                <li>
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item d-md-flex justify-content-between active">
                                    <div class="col-sm-6 text-center text-md-start m-auto">
                                        ...
                                        <p class="mb-5">هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى، حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص الأخرى.</p>
                                        <a href="#" class="btn btn-outline-light py-2 px-4 rounded-0 text-white">التفاصيل</a>
                                    </div>
                ...
                <div class="owl-nav">
                    <button
                        class="d-flex justify-content-center align-items-center owl-prev"
                        type="button"
                        data-bs-target="#intro-carousel"
                        data-bs-slide="prev"
                    >
                    ...
                    <button
                        class="d-flex justify-content-center align-items-center owl-next"
                        type="button"
                        data-bs-target="#intro-carousel"
                        data-bs-slide="next"
                    >
                                        ...
                                        <div class="row gy-4">
                                            <div class="tab-info__item">
                                                ...
                                                <div class="tab-info__content">
                                                    ...
                                                    <div class="tab-info__text">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Recusandae voluptate repellendus magni illo ea animi?</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6 mt-5">
                                <div class="card p-2">
                                    <div class="card-image">
                                        <a href="#">
                                            <img class="img-raised h-100 w-100" src="https://placehold.jp/3d4070/ffffff/1000x200.png">
                                        </a>
                                    </div>
                                    <div class="p-4">
